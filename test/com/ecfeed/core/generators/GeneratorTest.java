...
public class GeneratorTest { 
	...
	public void generateWithParameterCondition() {
		...
		performTestForParameterType("int");
		
//		performTestForParameterType("String"); // TODO MO-RE test for String fails
...
//		assertEquals(1, tests.size());
	...
	private void performTestForParameterType(String parameterType) {
	...
	private RootNode createModel(String parameterType) {
		...
		BasicParameterNode basicParameterNode1 = 
				MethodNodeHelper.addNewBasicParameter(methodNode, "par1", parameterType, "", true, null);
		
		BasicParameterNodeHelper.addNewChoiceToBasicParameter(basicParameterNode1, "choice1", "1", false, true, null);

		BasicParameterNode basicParameterNode2 = 
				MethodNodeHelper.addNewBasicParameter(methodNode, "par2", parameterType, "", true, null);
		
		BasicParameterNodeHelper.addNewChoiceToBasicParameter(basicParameterNode2, "choice2", "2", false, true, null);

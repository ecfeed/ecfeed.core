...
public class ModelSerializerTest {
	...
	private RootNode createModel(int version) {
		...
		private RootNode createModelComposite(int version) {
			...
			ChoiceNode m1p613c1 = MethodParameterNodeHelper.addChoiceToMethodParameter(m1p613, "M1P613C1", "1");
			ChoiceNode m1p613c2 = MethodParameterNodeHelper.addChoiceToMethodParameter(m1p613, "M1P613C2", "2");
			ChoiceNode m1p613c3 = MethodParameterNodeHelper.addChoiceToMethodParameter(m1p613, "M1P613C3", "3");

...
public class ModelSerializerWithConstraintsTest {
	...
	//        BasicParameterNode p1 = RootNodeHelper.addNewBasicParameter(model, "P1", "int", "0", true, null);
	...
	//
	//        MethodNode m1 = ClassNodeHelper.addNewMethod(c1, "Method1", true, null);
	//
	...
	//        ChoiceNode m1p1c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p1, "M1P1C1", "1");
	//        ChoiceNode m1p1c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p1, "M1P1C2", "2");
	////        ChoiceNode m1p1c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p1, "M1P1C3", "3");
	//
	...
	////        ChoiceNode m1p21c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p21, "M1P21C1", "1");
	////        ChoiceNode m1p21c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p21, "M1P21C2", "2");
	////        ChoiceNode m1p21c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p21, "M1P21C3", "3");
	//        BasicParameterNode m1p22 = ParametersAndConstraintsParentNodeHelper.addBasicParameterToParent(m1p2, "M1P22", "int");
	////        ChoiceNode m1p22c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p22, "M1P22C1", "1");
	////        ChoiceNode m1p22c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p22, "M1P22C2", "2");
	////        ChoiceNode m1p22c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p22, "M1P22C3", "3");
	//
	//        BasicParameterNode m1p3 = new BasicParameterNode("M1P3", "int", "0", false, null);
	////        ChoiceNode m1p3c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p3, "M1P3C1", "1");
	////        ChoiceNode m1p3c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p3, "M1P3C2", "2");
	//        ChoiceNode m1p3c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p3, "M1P3C3", "3");
	//
	...
	////        ChoiceNode m1p41c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p41, "M1P41C1", "1");
	////        ChoiceNode m1p41c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p41, "M1P41C2", "2");
	////        ChoiceNode m1p41c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p41, "M1P41C3", "3");
	//        BasicParameterNode m1p42 = ParametersAndConstraintsParentNodeHelper.addBasicParameterToParent(m1p4, "M1P42", "int");
	////        ChoiceNode m1p42c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p42, "M1P42C1", "1");
	////        ChoiceNode m1p42c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p42, "M1P42C2", "2");
	////        ChoiceNode m1p42c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p42, "M1P42C3", "3");
	//
	//        BasicParameterNode m1p5 = new BasicParameterNode("M1P5", "int", "0", false, null);
	////        ChoiceNode m1p5c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p5, "M1P5C1", "1");
	////        ChoiceNode m1p5c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p5, "M1P5C2", "2");
	////        ChoiceNode m1p5c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p5, "M1P5C3", "3");
	//
	...
	//        ChoiceNode m1p611c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p611, "M1P611C1", "1");
	////        ChoiceNode m1p611c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p611, "M1P611C2", "2");
	////        ChoiceNode m1p611c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p611, "M1P611C3", "3");
	//        BasicParameterNode m1p612 = ParametersAndConstraintsParentNodeHelper.addBasicParameterToParent(m1p61, "M1P612", "int");
	////        ChoiceNode m1p612c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p612, "M1P612C1", "1");
	////        ChoiceNode m1p612c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p612, "M1P612C2", "2");
	////        ChoiceNode m1p612c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p612, "M1P612C3", "3");
	//        BasicParameterNode m1p613 = ParametersAndConstraintsParentNodeHelper.addBasicParameterToParent(m1p61, "M1P613", "int");
	////        ChoiceNode m1p613c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p613, "M1P613C1", "1");
	////        ChoiceNode m1p613c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p613, "M1P613C2", "2");
	////        ChoiceNode m1p613c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p613, "M1P613C3", "3");
	...
	////        ChoiceNode m1p621c1 =
	//                MethodParameterNodeHelper.addNewChoice(m1p621, "M1P621C1", "1");
	////        ChoiceNode m1p621c2 =
	//                MethodParameterNodeHelper.addNewChoice(m1p621, "M1P621C2", "2");
	//        ChoiceNode m1p621c3 =
	//                MethodParameterNodeHelper.addNewChoice(m1p621, "M1P621C3", "3");
	...
	//// Internal constraint.
	//
	//        RelationStatement m1p61r1 = RelationSTesttatement.createRelationStatementWithChoiceCondition(

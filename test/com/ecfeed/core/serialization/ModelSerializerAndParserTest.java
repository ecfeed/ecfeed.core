...
public class ModelSerializerAndParserTest {
	...
	@Test 
	public void shouldSerializeAndParseGlobalStructureAtRootWithConstraintAtStructureLevel() {
	...
	@Test 
	public void shouldSerializeAndParseGlobalStructureAtClassWithConstraintAtStructureLevel() {
		...
		CompositeParameterNode globalCompositeParameterNode = 
				ClassNodeHelper.addNewCompositeParameter(classNode, "GS1", true, null);
	...
	@Test 
	public void shouldSerializeAndParseGlobalRootStructureWithParameterOneLevelDeeperThanConstraint() {
	...
	@Test 
	public void shouldSerializeAndParseGlobalClassStructureWithParameterOneLevelDeeperThanConstraint() {
		...
		try {
			...
			String tags = "<Constraint name=\"constraint\" type=\"EF\">\n" + 
					"            <Premise>\n" + 
					"                <Statement choice=\"GC1\" parameter=\"@root:class:GS1:GS2:GP1\" relation=\"equal\"/>\n" + 
					"            </Premise>\n" + 
					"            <Consequence>\n" + 
					"                <StaticStatement value=\"true\"/>\n" + 
					"            </Consequence>\n" + 

...
public class ChoicesParentNodeHelperTest {
	...
	public void traversingChoiceNodes(){
		...
		BasicParameterNode methodParameterNode1 = 
				ParametersAndConstraintsParentNodeHelper.addParameterToMethod(methodNode, "P1", "String");
	...
	public void copyChoicesOfOneLevel(){
		...
		BasicParameterNode methodParameterNode2 = 
				ParametersAndConstraintsParentNodeHelper.addParameterToMethod(methodNode, "P2", "String");

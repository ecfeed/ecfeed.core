...
public class CopyNodeTest{
	...
	public void copyRootTest(){
		...
		GlobalParameterNode par1 = new GlobalParameterNode("par1", "int", null);
		GlobalParameterNode par2 = new GlobalParameterNode("par2", "int", null);
	...
	public void copyMethodTest(){
		...
		ConstraintNode constraint1 = new ConstraintNode("constraint1", new Constraint("constraint1", ConstraintType.IMPLICATION, new StaticStatement(true, null), new StaticStatement(true, null), null), null);
		ConstraintNode constraint2 = new ConstraintNode("constraint2", new Constraint("constraint2", ConstraintType.IMPLICATION, new StaticStatement(true, null), new StaticStatement(true, null), null), null);
	...
	public void copyGlobalParameterTest(){
		GlobalParameterNode parameter = new GlobalParameterNode("parameter", "int", null);
	...
	public void copyConstraintTest(){
		...
		ConstraintNode constraint = new ConstraintNode("constraint", new Constraint("constraint", ConstraintType.IMPLICATION, precondition, postcondition, null), null);

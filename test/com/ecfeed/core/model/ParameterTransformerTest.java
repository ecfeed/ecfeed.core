...
public class ParameterTransformerTest {
	...
	public void linkMethodParameterToClassParameterBasicUseCaseForChoices() {
		...
		BasicParameterNode globalParameterNodeOfRoot = 
				RootNodeHelper.addNewBasicParameterToRoot(rootNode, globalParameterName, "String", "", true, null);
	...
	public void unlinkingMethodParameter() {
		...
		BasicParameterNode globalParameterNodeOfRoot1 = 
				RootNodeHelper.addNewBasicParameterToRoot(rootNode, "RP1", parameterType, "", true, null);

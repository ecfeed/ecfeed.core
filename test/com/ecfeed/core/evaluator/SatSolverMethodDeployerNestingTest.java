...
public class SatSolverMethodDeployerNestingTest {
    ...
    static BasicParameterNode m1p21 = MethodNodeHelper.addParameterToMethod(m1p2, "M1P21", "int");
    ...
    static BasicParameterNode m1p22 = MethodNodeHelper.addParameterToMethod(m1p2, "M1P22", "int");
    ...
    static BasicParameterNode m1p41 = MethodNodeHelper.addParameterToMethod(m1p4, "M1P41", "int");
    ...
    static BasicParameterNode m1p42 = MethodNodeHelper.addParameterToMethod(m1p4, "M1P42", "int");
    ...
    static BasicParameterNode m1p611 = MethodNodeHelper.addParameterToMethod(m1p61, "M1P611", "int");
    ...
    static BasicParameterNode m1p621 = MethodNodeHelper.addParameterToMethod(m1p62, "M1P621", "int");

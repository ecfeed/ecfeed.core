...
public class DataTypeGeneralTest {
    private DataType type;

    @BeforeEach
    void setUp() {

        type = DataTypeFactory.create(false);
    }
    ...
    void determineFloatTest() {
        ...
        Assertions.assertEquals("float", type.determine());
    }
    ...
    void determineFloatFalseTest() {
        ...
        Assertions.assertNotEquals("float", type.determine());
    }
    ...
    void determineByteTest() {
        ...
        Assertions.assertEquals("byte", type.determine());
    }
    ...
    void determineByteFalseTest() {
        ...
        Assertions.assertNotEquals("byte", type.determine());
    }
    ...
    void determineShortTest() {
        ...
        Assertions.assertEquals("short", type.determine());
    }
    ...
    void determineShortFalseTest() {
        ...
        Assertions.assertNotEquals("short", type.determine());
    }

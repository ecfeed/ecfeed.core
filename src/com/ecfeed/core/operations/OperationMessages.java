...
public class OperationMessages {
	...
	public static final String CONSTRAINT_NOT_ALLOWED = "Constraint name not allowed.";
	public static final String TEST_CASE_NOT_ALLOWED = "Test case name not allowed.";

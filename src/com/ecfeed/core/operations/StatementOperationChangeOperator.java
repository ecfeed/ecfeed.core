...
public class StatementOperationChangeOperator extends AbstractModelOperation {
	...
	public StatementOperationChangeOperator(StatementArray target, EStatementOperator operator, ExtLanguage viewMode) {
		super(OperationNames.CHANGE_STATEMENT_OPERATOR, viewMode);
		fTarget = target;
	...
	public IModelOperation getReverseOperation() {
		return new StatementOperationChangeOperator(fTarget, fCurrentOperator, getViewMode());
	}

...
public abstract class MethodDeployer {
	...
	public static MethodNode construct(List<MethodParameterNode> parameters, List<ConstraintNode> constraints) {
		...
		parameters.stream().map(MethodParameterNode::createCopy).forEach(method::addParameter);
